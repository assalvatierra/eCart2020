...
namespace eCart.Areas.Admin.Controllers
{
    public class StoreKiosksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,StoreDetailId,KioskName")] StoreKiosk storeKiosk)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,StoreDetailId,KioskName")] StoreKiosk storeKiosk)
        {
            if (ModelState.IsValid)
            {
